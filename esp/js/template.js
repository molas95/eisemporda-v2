$(document).ready(function(){
	...
	$('#logo1').click(function(e){
		$('#descripcio1').fadeToggle('slow');
	});
	// Veure descripció
	$('#logo2').click(function(e){
		$('#descripcio2').fadeToggle('slow');
	});
	// Veure descripció
	$('#logo3').click(function(e){
		$('#descripcio3').fadeToggle('slow');
	});
	// Veure descripció
	$('#logo4').click(function(e){
		$('#descripcio4').fadeToggle('slow');
	});
